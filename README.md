...
클라우드프레스는 워드프레스/PHP/정적/DNS/스토리지 트래픽 무제한 정책을 기본으로 하며 자체 NoSQL Database인 **CloudPressDB**, 자체 스토리지 상품 **CP3**, PHP-WASM 기반 워드프레스 호스팅, 정적 사이트, PHP 사이트를 제공하는 클라우드 서비스입니다.
